...
The licensing details for `django-rbaca` are currently pending. Please refer to the :ref:`License` section in the main documentation for updates on the licensing terms and conditions.
